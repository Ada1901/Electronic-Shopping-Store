...
public class UserController {
	...
	public ResponseEntity<ApiResponseMessage> deleteUser(@PathVariable String userId) {
		...
		ApiResponseMessage message = ApiResponseMessage.builder().message("User is deleted sucessfully").sucess(true)
	...
	public ResponseEntity<ImageResponse> uploadUserImage(@RequestParam("userImage") MultipartFile image,
		...
		ImageResponse imageResponse = ImageResponse.builder().imageName(imageName).sucess(true).status(HttpStatus.OK)
				.build();
