...
import com.lcwa.electonic.store.dto.ImageResponse;
...
public class ProductController {
	...
	public ResponseEntity<ApiResponseMessage> delete(@PathVariable String productId) {
		...
		ApiResponseMessage responseMessage = ApiResponseMessage.builder().message("Product is deleted successfully !!")
				.status(HttpStatus.OK).sucess(true).build();
    ...
    public ResponseEntity<ImageResponse> uploadProductImage(
        ...
        ProductDto productDto = productService.get(productId);
        productDto.setProductImageNmae(fileName);
        ProductDto updatedProduct = productService.update(productDto, productId);
        ImageResponse response = ImageResponse.builder().imageName(updatedProduct.getProductImageNmae()).message("Product image is successfully uploaded !!").status(HttpStatus.CREATED).sucess(true).build();
    ...
    public void serveUserImage(@PathVariable String productId, HttpServletResponse response) throws IOException {
        ProductDto productDto = productService.get(productId);
        InputStream resource = fileService.getResource(imagePath, productDto.getProductImageNmae());
